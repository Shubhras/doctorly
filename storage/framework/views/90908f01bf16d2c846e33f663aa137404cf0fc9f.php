                        ...
                        <?php if($role != 'patient' && $role != 'receptionist'): ?>
                            <a href=" <?php echo e(route('doctor.create')); ?> ">
                                <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                    ...
                                    <i class="bx bx-plus font-size-16 align-middle mr-2"></i> <?php echo e(__('Nueva Staff')); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/doctorly/resources/views/doctor/doctors.blade.php ENDPATH**/ ?>