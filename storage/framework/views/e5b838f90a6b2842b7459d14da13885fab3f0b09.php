            ...
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">
                        ...
                        <?php else: ?>
                            <?php echo e(__('Agregar Nuevo Staff')); ?>
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(url('doctor')); ?>"><?php echo e(__('Staff')); ?></a></li>
            ...
            <div class="col-12">
                ...
                <?php else: ?>
                    <a href="<?php echo e(url('doctor')); ?> ">
                        <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                        <!-- <i class="bx bx-arrow-back font-size-16 align-middle mr-2"></i><?php echo e(__('Back to Staff List')); ?> -->
                            <i
                                class="bx bx-arrow-back font-size-16 align-middle mr-2"></i><?php echo e(__('Volver a Staff')); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Primer nombre ')); ?><span
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <!-- <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Título ')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <!-- <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Experiencia ')); ?><span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            <label class="control-label"><?php echo e(__('Tiempo (en minutos) ')); ?><span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-12">
                                            <div class='repeater mb-4'>
                                                <div data-repeater-list="TimeSlot" class="form-group">
                                                    ...
                                                    <label><?php echo e(__('Tiempo disponibles ')); ?><span
                                                            class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Apellido ')); ?><span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <!-- <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Teléfono ')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <!-- <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Grado ')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <!-- <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Tarifa ')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group" style="padding-top:8px;margin-bottom:21px;">
                                            <label class="control-label d-block"><?php echo e(__("Días disponibles ")); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Foto de perfil ')); ?><span
                                                    class="text-danger">*</span></label>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/doctorly/resources/views/doctor/doctor-details.blade.php ENDPATH**/ ?>