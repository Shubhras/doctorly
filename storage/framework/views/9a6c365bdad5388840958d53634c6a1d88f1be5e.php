...
<?php $__env->startSection('body'); ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <?php $__env->startComponent('components.breadcrumb'); ?>
            ...
            <?php $__env->slot('li_2'); ?> Calendario <?php $__env->endSlot(); ?>
        ...
        <div class="row">
            <div class="col-12">
                <a href="<?php echo e(url('/appointment/create')); ?>"
                    ...
                    <i class="mdi mdi-arrow-left  font-size-16 align-middle mr-2"></i> <?php echo e(__('Atrás')); ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                <iframe id="JotFormIFrame-221297017399160" title="BTC Scheduling" src="https://hipaa.jotform.com/app/221297017399160?appEmbedded=1" style="height:1400px;border: 0;"></iframe>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/doctorly/resources/views/appointment/appointment_create.blade.php ENDPATH**/ ?>