            ...
            <div class="col-12">
                ...
                <?php else: ?>
                    <a href="<?php echo e(url('patient')); ?>">
                        <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                            <!-- <i class="bx bx-arrow-back font-size-16 align-middle mr-2"></i><?php echo e(__('Back to Patient List')); ?> -->
                            <i class="bx bx-arrow-back font-size-16 align-middle mr-2"></i><?php echo e(__('Volver a Pacientes')); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Direccion actual ')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Edad ')); ?><span
                                                    class="text-danger">*</span></label>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/doctorly/resources/views/patient/patient-details.blade.php ENDPATH**/ ?>