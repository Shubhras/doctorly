...
<?php $__env->startSection('body'); ?>
    ...
    <div style="display:none;">
        ...
        <?php $__env->startComponent('components.breadcrumb'); ?>
            ...
            <?php $__env->slot('title'); ?>Crear historial medico <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_1'); ?> Dashboard <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_2'); ?> Historial medico <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_3'); ?> Crear historial medico <?php $__env->endSlot(); ?>
            ...
            <div class="col-12">
                <a href="<?php echo e(url('prescription')); ?>">
                    <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                        <i
                            class="bx bx-arrow-back font-size-16 align-middle mr-2"></i><?php echo e(__('Volver a la Historia Médica')); ?>
