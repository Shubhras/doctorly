...
<?php $__env->startSection('body'); ?>
    ...
    <div style="display:none;">
        ...
        <?php $__env->startComponent('components.breadcrumb'); ?>
            ...
            <?php $__env->slot('title'); ?> Bandeja de entrada de historial médico <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_1'); ?> Dashboard <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_2'); ?> Bandeja de entrada de historial médico <?php $__env->endSlot(); ?>
                        ...
                        <?php if($role == 'doctor'): ?>
                            <a href=" <?php echo e(route('prescription.create')); ?> ">
                                <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                    ...
                                    <?php echo e(__('Crear historial medico')); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/doctorly/resources/views/prescription/prescriptions.blade.php ENDPATH**/ ?>